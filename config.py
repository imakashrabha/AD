...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7619221636:AAEAvRqmgmwSbHg6B36Q5N5j3Tufjatf5Ow")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002368503724"))
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002447725562"))
...
try:
    ADMINS=[6987158459]
    for x in (os.environ.get("ADMINS", "6987158459 1473392446 6165669080").split()):
        ADMINS.append(int(x))
except ValueError:
...
USER_REPLY_TEXT = "𝖸𝗈𝗎'𝗋𝖾 𝗇𝗈𝗍 𝖺𝖽𝗆𝗂𝗇"
