...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7290653291:AAEmQj9UqZ9PcXjT2OZJjWh_ZWQdKRxXLDQ")
...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5414733218"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002177725676"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002186197570"))
...
try:
    ADMINS=[5414733218]
    for x in (os.environ.get("ADMINS", "5414733218 6987158459").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @On_flix</b>")
